...
// Toutes les routes ici nécessitent super admin
router.use(requireAuth, requireSuperAdmin);

// GET /api/admin/users — liste tous les utilisateurs avec leur abonnement
...
// PATCH /api/admin/users/:id/block — bloquer/débloquer
