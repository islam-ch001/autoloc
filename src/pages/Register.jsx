  ...
  return (
    <div style={styles.shell}>
      <form onSubmit={handleSubmit} style={styles.card}>
        ...
        <p style={styles.subtitle}>Rejoignez la plateforme AutoLoc</p>
        ...
        <div style={styles.field}>
          ...
          <div style={styles.inputWrap}>
            ...
            <input type="text" required value={name} onChange={e => setName(e.target.value)}
              placeholder="Ahmed Bouzid" style={styles.input} />
          </div>
        </div>
        ...
        <button type="submit" disabled={loading} style={{ ...styles.button, opacity: loading ? 0.7 : 1 }}>
          {loading ? <><Loader2 size={16} className="spin" /> Création...</> : 'Créer mon compte'}
        </button>
...
const styles = {
  ...
  footer: { textAlign: 'center', fontSize: 13, color: '#707088', margin: 0 },
